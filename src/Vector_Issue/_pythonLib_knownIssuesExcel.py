...
class KnownIssuesExcel:
    ...
    def __init__(self, file, cbdOld):
        ...
        if cbdOld == 1:
            self.dvMQStatus = DataValidation(type="list", formula1='"Open,Closed"', allow_blank=False)
        else:
            self.dvMQStatus = DataValidation(type="list", formula1='"Not analyzed,Affected,Not affected,Workaround used"', allow_blank=False)
